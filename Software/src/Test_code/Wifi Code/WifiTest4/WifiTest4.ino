...
#define EAP_IDENTITY "NUSSTU\E0774750" //nickname@example.com, at some organizations should work nickname only without realm, but it is not recommended
#define EAP_PASSWORD "NEwk5urKFnt8Mqd" //password for eduroam account
#define EAP_USERNAME "NUSSTU\E0774750" // the Username is the same as the Identity in most eduroam networks.

//SSID NAME
const char* ssid = "NUS_STU"; // eduroam SSID, "eduroam"
