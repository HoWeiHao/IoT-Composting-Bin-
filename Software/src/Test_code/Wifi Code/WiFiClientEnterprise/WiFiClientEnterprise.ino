...
#define EAP_IDENTITY "FURNACE" //if connecting from another corporation, use identity@organisation.domain in Eduroam 
#define EAP_USERNAME "FURNACE" //oftentimes just a repeat of the identity
#define EAP_PASSWORD "6JPJZWjsDE2HMFDp" //your Eduroam password
const char* ssid = "FURNACE"; // Eduroam SSID
